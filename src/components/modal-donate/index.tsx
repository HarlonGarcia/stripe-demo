...
const ModalDonate = ({ title, isOpen, onClose }: ModalDonateProps) => {
  ...
  return (
    <div className='relative z-10' aria-labelledby='ModalDonate-title' role='dialog' aria-ModalDonate='true'>
